...
const NAV_ITEMS = [
  ...
  { href: "/dashboard/builder", label: "Chart Builder", icon: Icons.builder },
  { href: "/upload", label: "Upload Data", icon: Icons.upload },
  { href: "/reports", label: "Reports", icon: Icons.reports },
  { href: "/nlq", label: "NLQ Chat", icon: Icons.chat },
  { href: "/data/joins", label: "Data Joins", icon: Icons.joins },
  { href: "/data/ml", label: "ML Insights", icon: Icons.ml },
